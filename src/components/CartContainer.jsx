      ...
      <div className='w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col'>
        <div className='w-full h-340 md:h-42 px-6 py-10 flex flex-col gap-3 overflow-y-scroll scrollbar-none'>
          ...
          <div className='w-full p-1 px-2 rounded-lg bg-cartItem flex items-center gap-2'>
            <img src="https://firebasestorage.googleapis.com/v0/b/restaurantapp-c4f0e.appspot.com/o/Images%2F1709628016762-r4.png?alt=media&token=fb672994-9a01-4774-a049-108d8b8bf074" alt='rice'className='w-20 h-20 max-w-[60px] rounded-full object-contain' />
            {/* Name */}
