  ...
  return (
    <div className='w-full min-h-screen flex  h-auto items-center justify-center'>
      <div className='w-[90%] md:w-[75%] border border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center gap-4 '>
        ...
        <MdFastfood className='textxl text-gray-700 ' />
        ...
        <label className='w-full h-full flex flex-col items-center justify-center cursor-pointer'>
          ...
          <input type='file' name='uploadimage' accept='image/*' onChange={uploadImage} className='w-full h-full object-cover' />
        </label> 
        </> :   <><div className='relative h-full '> <img src={imageAsset} alt="uploaded image" />
        <button type='button' className='absolute bottom-3 right-3 p-3 rounded-full bg-red-500 cursor-pointer outline-none hover:shadow-md duration-500 transition-all ease-in-out' onClick={deleteImage}>
          ...
          <div className='flex items-center w-full'>
            <button type='button' className='ml-0 md:ml-auto w-full ml:w-auto border-none outline-none bg-emerald-500 px-12 py-2 rounded-lg text-lg text-white font-semibold' onClick={saveDetails}>
              Save
            </button>
          </div>
      </div>
